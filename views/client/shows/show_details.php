...
<body>
    ...
    <div class="video-container">
        ...
        <div class="overlay">
            ...
            <div class="show-reserve">
                ...
                <button onclick="redirectTo('../reserve.php?show_id=<?php echo $show['id']; ?>')">Rezervo</button>
            </div>
        </div>
    </div>
    ...
    <div class="show-container">
        ...
        <div class='btn-group'>
            ...
            <button onclick="window.location.href = '/biletaria_online/views/admin/reservations/index.php?show_id=<?php echo $show['id'] ?>'">Rezervime</button>
            <?php endif; ?>
        </div>
    </div>
    ...
    <section id="reviews" class="owl-carousel owl-theme">
        ...
        if ($reviews->num_rows > 0) {
            ...
            <div class="item review">
                ...
                <div class="comment">
                    <p class="comment-preview">
                        Nuk ka vlerësime apo komente për këtë shfaqje!...
                        <span class="read-more" onclick="toggleFullComment(this)">Lexo më shumë</span>
                    </p>
                    <p class="comment-full">
                        Nuk ka vlerësime apo komente për këtë shfaqje! Ndiqni shfaqjen dhe bëhuni të parët për të dhënë një vlerësim apo koment. Ju garantojmë një eksperiencë të mrekullueshme!
                        <br>Shënim: Formulari i vlerësimit ju vjen automatikisht në email-in tuaj pas mbarimit të shfaqjes që keni ndjekur.
                        <span class="read-less" onclick="toggleFullComment(this)"> Lexo më pak</span>
                    </p>
                </div>
            </div>
