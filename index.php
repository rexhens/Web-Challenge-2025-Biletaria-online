				...
				<div class="headerhny-title">
					<div class="w3l-title-grids">
						<div class="headerhny-left">
							<h3 class="hny-title">Popular Shows</h3>
						</div>
			...
			<div class="container py-lg-3">
				...
				<div class="owl-three owl-carousel owl-theme">
					<div class="item vhny-grid">
						...
						<h3> <a class="title-gd" href="movies.html">FLI</a></h3>
						<p>një konceptim modern dhe aktual i veprës “Ifigjenia në Aulidë” të Euripidit, sjellë në skenë me regji dhe dramaturgji nga Enton Kaca. Kjo vepër, premiera e së cilës do të ngjitet në skenë në datën 28 prill është një nga veprat më të njohura ....</p>
						<div class="button-center text-center mt-4">
							<a href="movies.html" class="btn watch-button">Prenoto Bilete</a>
						</div>
					...
					<div class="item vhny-grid">
						...
						<h3> <a class="title-gd" href="movies.html">MetroSound </a></h3>
						<p>“Jehonë Arbëreshe” , është një projekt, i cili po organizohet për të hapur gjithnjë e më shumë dimensione të tjera koncert pas koncerti dhe për t’i dhënë mundësinë publikut të jetë totalisht pjesë e këtij evenimenti tematik ....</p>
						<div class="button-center text-center mt-4">
							<a href="movies.html" class="btn watch-button">Prenoto Bilete</a>
						</div>
					</div>
					<div class="item vhny-grid">
						...
						<h3> <a class="title-gd" href="movies.html">Tre dimra</a></h3>
						<p>Një shfaqje që vë në optikën e kohërave figurën e gruas dhe zërin e saj. Tre periudhat historike të tranzicionit që ka kaluar apo vazhdojnë të jenë në proces popujt e rajonit tonë, si Shqipëria e Kroacia me një ngjashmëri të plotë me realitetet ....</p>
						<div class="button-center text-center mt-4">
							<a href="movies.html" class="btn watch-button">Prenoto Bilete</a>
						</div>
					</div>
					<div class="item vhny-grid">
						...
						<h3> <a class="title-gd" href="movies.html">Metrofest 5 – Drama shqipe si formë njohjeje dhe kërkimi</a></h3>
						<p>Për të pestin vit me radhë, Teatri Metropol organizon festivalin dedikuar veprës shqiptare të arkivit. Puna për realizim ka nisur në muajin tetor, ndërsa muaji nëntor do të jetë muaji ....</p>
						<div class="button-center text-center mt-4">
							<a href="movies.html" class="btn watch-button">Prenoto Bilete</a>
						</div>
					...
					<div class="item vhny-grid">
						...
						<h3> <a class="title-gd" href="movies.html">MOTEL SAZANI – LIVE AMBIENT ELECTRONICA CONCERT</a></h3>
						<p>Një performancë koncertuale LIVE në rrymën “Ambient Electronica” me produksione të pa publikuara më parë ....</p>
						<div class="button-center text-center mt-4">
							<a href="movies.html" class="btn watch-button">Prenoto Bilete</a>
						</div>
					</div>
					<div class="item vhny-grid">
						...
						<h3> <a class="title-gd" href="movies.html">Mbreti Lir</a></h3>
						<p>Një nga tragjeditë më të mëdha të Uilliam Shekspir, do të ngjitet së shpejti në skenën e Teatrit Metropol, si premiera e cila do të çelë sezonin e ri artistik.Me regjinë e Jonida Beqos dhe një kast fantastik aktorësh, fundjavën e fundit të shtatorit dhe gjatë gjithë muajit tetor ....</p>
						<div class="button-center text-center mt-4">
							<a href="movies.html" class="btn watch-button">Prenoto Bilete</a>
						</div>
					</div>
